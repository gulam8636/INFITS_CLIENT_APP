    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q3_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q3", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("milk", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (milk.equals(""))
                    ...
                    SectionPref.saveformsection6("milk",milk,2,preval,3,"STEP6Q3",requireContext());
