    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q10_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q10", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("dry_fruits", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dry_fruits.equals(""))
                    ...
                    SectionPref.saveformsection6("dry_fruits",dry_fruits,9,preval,10,"STEP6Q10",requireContext());
