    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q1_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q1", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("cereals", "");
...
//                    int preval =       sharedPreferences2.getInt("progress6",0);
                    SectionPref.saveformsection6("cereals",cereals,0,0,1,"STEP6Q1",requireContext());
