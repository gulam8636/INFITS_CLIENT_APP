    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q8_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q8", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("bloating", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.bloating = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bloating.equals(""))
                    ...
                    SectionPref.saveformsection3("bloating",bloating,7,preval,8,"STEP3Q8",requireContext());
