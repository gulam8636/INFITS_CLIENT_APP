    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section5Q3_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP5Q3", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("snack", "");
        if(!storedvalue.isEmpty()) {
            eTextHeight.setText(storedvalue);
            DataSectionFive.snack = storedvalue;
        }
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (snack.equals(""))
                    ...
                    SectionPref.saveformsection5("snack",eTextHeight.getText().toString(),2,preval,3,"STEP5Q3",requireContext());
