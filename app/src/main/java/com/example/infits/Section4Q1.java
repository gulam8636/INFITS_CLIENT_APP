    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section4Q1_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP4Q1", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("walking", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionFour.walking = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (walking.equals(""))
                    ...
                    SectionPref.saveformsection4("walking",walking,0,0,1,"STEP4Q1",requireContext());
