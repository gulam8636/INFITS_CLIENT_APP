    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q7_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q7", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("veg_other", "");
         ...
         nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (veg_other.equals(""))
                    ...
                    SectionPref.saveformsection6("veg_other",veg_other,6,preval,7,"STEP6Q7",requireContext());
