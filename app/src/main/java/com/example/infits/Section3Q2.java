    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q2_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q2", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("constipation", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.constipation = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (constipation.equals(""))
                    ...
                    SectionPref.saveformsection3("constipation",constipation,1,preval,2,"STEP3Q2",requireContext());
