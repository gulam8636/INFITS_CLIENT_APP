    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q9_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q9", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("fats", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fats.equals(""))
                    ...
                    SectionPref.saveformsection6("fats",fats,8,preval,9,"STEP6Q9",requireContext());
