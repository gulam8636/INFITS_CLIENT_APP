    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q3_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q3", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("diarrhoea", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.diarrhoea = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (diarrhoea.equals(""))
                    ...
                    SectionPref.saveformsection3("diarrhoea",diarrhoea,2,preval,3,"STEP3Q3",requireContext());
