    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q4_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q4", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("nausea", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.nausea = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nausea.equals(""))
                    ...
                    SectionPref.saveformsection3("nausea",nausea,3,preval,4,"STEP3Q4",requireContext());
