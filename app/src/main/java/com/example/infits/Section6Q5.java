    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q5_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q5", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("roots", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (roots.equals(""))
                    ...
                    SectionPref.saveformsection6("roots",roots,4,preval,5,"STEP6Q5",requireContext());
