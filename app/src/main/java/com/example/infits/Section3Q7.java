    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q7_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q7", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("hairfall", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.hairfall = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (hairfall.equals(""))
                    ...
                    SectionPref.saveformsection3("hairfall",hairfall,6,preval,7,"STEP3Q7",requireContext());
