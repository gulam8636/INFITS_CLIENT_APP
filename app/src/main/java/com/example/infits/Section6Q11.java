    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q11_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q11", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("sugar", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sugar.equals(""))
                    ...
                    SectionPref.saveformsection6("sugar",sugar,10,preval,11,"STEP6Q11",requireContext());
