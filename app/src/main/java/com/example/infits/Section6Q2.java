    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q2_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q2", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("pulses", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pulses.equals(""))
                    ...
                    SectionPref.saveformsection6("pulses",pulses,1,preval,2,"STEP6Q2",requireContext());
