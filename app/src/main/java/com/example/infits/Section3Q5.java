    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section3Q5_to_consultationFragment);

            }
        });


        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP3Q5", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("vomiting", "");
        if(!storedvalue.isEmpty()) {
            ...
            DataSectionThree.vomiting = storedvalue;
        }
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (vomiting.equals(""))
                    ...
                    SectionPref.saveformsection3("vomiting",vomiting,4,preval,5,"STEP3Q5",requireContext());
