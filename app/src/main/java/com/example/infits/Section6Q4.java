    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q4_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q4", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("milkprod", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (milkprod.equals(""))
                    ...
                    SectionPref.saveformsection6("milkprod",milkprod,3,preval,4,"STEP6Q4",requireContext());
