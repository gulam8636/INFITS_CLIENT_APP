    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q12_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q12", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("fastfood", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fastfood.equals(""))
                    ...
                    SectionPref.saveformsection6("fastfood",fastfood,11,preval,12,"STEP6Q12",requireContext());
