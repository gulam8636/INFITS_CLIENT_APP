    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_section6Q8_to_consultationFragment);

            }
        });

        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("STEP6Q8", Context.MODE_PRIVATE);
        String storedvalue = sharedPreferences.getString("fruits", "");
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fruits.equals(""))
                    ...
                    SectionPref.saveformsection6("fruits",fruits,7,preval,8,"STEP6Q8",requireContext());
